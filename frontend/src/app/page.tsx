        ...
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex space-x-6 text-gray-700">
              <a href="#" className="border-b-2 border-indigo-600 pb-1">홈</a>
              <a href="#" className="hover:text-indigo-600">카테고리</a>
              <a href="#" className="hover:text-indigo-600">인기글</a>
              <a href="#" className="hover:text-indigo-600">태그</a>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <div className="relative">
              <input type="text" placeholder="검색" className="pl-3 pr-10 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-64" />
            ...
            <button className="bg-yellow-400 text-black px-4 py-2 rounded-md hover:bg-yellow-500 transition">로그인</button>
            <button className="border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-50 transition">회원가입</button>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">조용히 호칭만의 시간을 보내기 좋은 카페를 소개합니다...</p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between mb-8">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-600 text-sm">당신의 이야기를 공유하고 소통하는 공간입니다. 일상의 특별한 순간들을 기록하고 다른 사람들과 나눠보세요.</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-gray-800 font-medium mb-4">고객센터</h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li><a href="#" className="hover:text-indigo-600">자주 묻는 질문</a></li>
                  <li><a href="#" className="hover:text-indigo-600">1:1 문의</a></li>
                  <li><a href="#" className="hover:text-indigo-600">공지사항</a></li>
                </ul>
              </div>
              <div>
